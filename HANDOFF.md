...
> 22. `.auto-memory/reference_radio_store_slices.md` — `s.playback.isPlaying` not `s.isPlaying` (slice-confusion trap)
> 23. `.auto-memory/project_deploy_checklist.md` — deploy punch list if that's where we are
>
